...
public class GamePlayerTest
{
	...
	public static void main(String [] args) throws IOException
	{
		...
		GamePlayer P = new GamePlayer("Mortimer");  // Create a new GamePlayer
		...
		// for the user.  In the examples below, player P first succeed in 5 tries
		...
		// from the file so that his / her information is updated each time he / she plays
		// the game.
	}		
}
